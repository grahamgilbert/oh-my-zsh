...
#PROMPT=$'%{$fg[red]%}┌(%!) [%{$fg_bold[white]%}%n@%m%{$reset_color%}%{$fg[red]%}] [%{$fg_bold[white]%} $(vmfusionlist)%{$reset_color%}%{$fg[red]%}] %{$(git_prompt_info)%}%(?,,%{$fg[red]%}[%{$fg_bold[white]%}%?%{$reset_color%}%{$fg[red]%}])
